...
public class ZoomOptions {
     ...
     * @param type           allow zooming either on both x-axis, y-axis or on both axis.
     *                       Known Issue: In synchronized charts, xy or y will not update charts in sync,
     *                       while x will work correctly.
