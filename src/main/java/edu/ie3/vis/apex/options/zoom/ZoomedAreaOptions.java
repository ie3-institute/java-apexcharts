...
/**
 * Options to be set for a zoomed area in axis charts.
 * The zoomed area is the area which is drawn when a user drags the mouse from one point to another.
 * Also see https://apexcharts.com/docs/options/chart/zoom/ for details
 *
 * @version 0.1
 * @since 21.01.20
 */
